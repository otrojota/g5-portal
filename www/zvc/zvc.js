...
class ZVC {
    ...
    static async loadComponent(domElement, parentController, path, useControllerClass, useHTML) {
        ...
        if (useControllerClass && useHTML !== undefined && useHTML !== null) {
        ...
        let pJs = import(dir + "/" + componentName + ".js" + (ZVC.forceClassesReload?"?update=" + Date.now():""));
        try {
            ...
            if (!resJS || !resJS.default || !(typeof resJS.default == "function")) {
                console.error(dir + "/" + componentName + ".js cannot be loaded as ES6 Module or does not export a default subclass of ZCustomController");
                return;
            }
            let html = await resHtml.text();
            ZVC.lastHTML = html;
            ZVC.lastExportedClass = null;
            let controllerClass = resJS.default;
...
export {ZVC, ZController, ZBasicController, ZCompoundController, ZDialog, ZCustomController, ZButton, ZInput, ZSelect, ZDynamicSelect, ZLoader, ZRepeater}